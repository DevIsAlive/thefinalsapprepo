...
namespace RapidOcrNet
{
    internal static class OcrUtils
    {
        public static Tensor<float> SubtractMeanNormalize(SKBitmap src, float[] meanVals, float[] normVals)
        {
            ...
            Tensor<float> inputTensor = new DenseTensor<float>(new int[] { 1, expChannels, rows, cols });
        ...
        public static SKBitmap GetRotateCropImage(SKBitmap src, SKPointI[] box)
        {
            ...
            SKPointI[] points = new SKPointI[] { box[0], box[1], box[2], box[3] }; // Clone points
            int[] collectX = new int[] { box[0].X, box[1].X, box[2].X, box[3].X };
            ...
            int[] collectY = new int[] { box[0].Y, box[1].Y, box[2].Y, box[3].Y };
        ...
        {
            var info = src.Info;
            int tempWidth = info.Width;
            info.Width = info.Height;
            info.Height = tempWidth;
